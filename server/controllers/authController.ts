...
export const googleSuccess = async (
    ...
    try {
        ...
        // Append ?auth=google&exchange=... so the frontend can immediately establish first-party cookies
        return res.redirect(`${frontendUrl}/dashboard?auth=google&exchange=${exchangeToken}`);
