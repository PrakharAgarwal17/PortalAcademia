...
| `/trends/institution` | [client/src/pages/trends/InstitutionTrendsPage.tsx](file:///client/src/pages/trends/InstitutionTrendsPage.tsx) | **Role: Institution** | University cohort diagnostic observatory: live talent supply vs industry market demand curves, curriculum deficit benchmarking, zero-student edge-case protection, and dynamic curriculum reform proposals based on actual cohort deficiencies. | `Navbar`, `Recharts (BarChart, ResponsiveContainer)` |
...
| `/assessments` | [client/src/pages/SkillAssessmentsPage.tsx](file:///client/src/pages/SkillAssessmentsPage.tsx) | **Protected** (Authenticated) | Standardized technical and soft-skill MCQ examination center: trending skill test catalog, pass/fail status with non-destructive Retest action, cumulative average-of-attempts score display, automated badge certification, and test runner triggers. | `Navbar`, `SkillBadge`, `TestConfirmationModal`, `SkillTestRunnerModal` |
