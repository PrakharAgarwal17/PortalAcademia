  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <header className="sticky top-0 z-30 bg-card border-b border-border px-4 lg:px-8 py-2.5 flex items-center justify-between">
        ...
        {/* Quick Persona Navigation Bar for Judges & Evaluators */}
        <div className="hidden md:flex items-center gap-1 text-xs font-medium">
          ...
          <Link
            ...
            className="px-2 py-1 rounded-md bg-primary text-primary-foreground font-semibold"
          >
            Student
          </Link>
          <Link
            to="/dashboard/faculty"
            className="px-2 py-1 rounded-md hover:bg-secondary text-foreground"
          >
            Faculty
          </Link>
          <Link
        ...
        <div className="fixed inset-y-0 right-0 z-50 w-full max-w-md bg-card border-l border-border shadow-xl flex flex-col">
          <div className="p-4 border-b border-border flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-xs font-bold text-foreground">AI Career Guide</h3>
                <p className="text-[10px] text-muted-foreground font-mono">SIH 26044 Contextual Telemetry</p>
              </div>
            </div>
            <button
              type="button"
          ...
          <form onSubmit={handleSendAiMessage} className="p-3 border-t border-border flex gap-2">
            <input
              ...
              placeholder="Ask about skill gaps, postings, interview prep…"
