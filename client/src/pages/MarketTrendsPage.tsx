...
import { Loader2, GraduationCap, Landmark, ArrowRight, ShieldCheck } from "lucide-react";
...
export default function MarketTrendsPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto p-4 lg:p-8 flex flex-col justify-center space-y-8 my-auto">
        <div className="text-center space-y-2">
          <div className="inline-flex items-center gap-1.5 text-[10px] font-mono px-2.5 py-0.5 rounded bg-primary/10 text-primary border border-primary/20 font-bold">
            ...
            Specialized National Intelligence Hubs
          </div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-foreground tracking-tight">
            Select Your Intelligence Observatory
          </h1>
          <p className="text-xs sm:text-sm text-muted-foreground max-w-xl mx-auto">
            Faculty scholars and candidate students have distinct decision-making parameters. Explore dedicated telemetry built specifically for your domain.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div
            ...
            className="group relative bg-card border border-border/80 hover:border-primary/50 rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:-translate-y-1 cursor-pointer space-y-4 overflow-hidden"
          >
            <div className="space-y-3">
              <div className="w-12 h-12 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-primary group-hover:scale-105 transition-transform">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Analyze corporate hiring demand histograms, verified stipend bands (₹65K–₹1.5L/mo), regional internship clusters, and personalized skill gap diagnostics.
                </p>
              </div>
            </div>
          ...
          >
            <div className="space-y-3">
              <div className="w-12 h-12 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-600 dark:text-purple-400 group-hover:scale-105 transition-transform">
                <Landmark className="w-6 h-6" />
              </div>
              <div className="space-y-1">
                <span className="text-[10px] font-mono uppercase tracking-wider text-muted-foreground font-bold">
                  For Faculty & Academic Scholars
                </span>
                <h2 className="text-lg font-bold text-foreground group-hover:text-primary transition-colors">
